...
# .\unwrapLaplacian.m:32
    ...
    Y,X,Z=np.meshgrid(arange(- matrix_size[1] / 2,matrix_size[1] / 2 - 1),arange(- matrix_size[0] / 2,matrix_size[0] / 2 - 1),arange(- matrix_size[2] / 2,matrix_size[2] / 2 - 1))
...
# .\unwrapLaplacian.m:42
    if matrix_size[2] > 1:
        h=np.array(multiply((logical_and(logical_and((X == 0),(Y == 0)),(Z == 0))),1))
...
# .\unwrapLaplacian.m:48
        ...
        h=multiply((logical_and((X == 0),(Y == 0))),1)
